...
public class BankDatabaseSimulation {
    ...
    // The function populates the bank account table.
    // We have three users. Each has a checking or saving account.
    ...
    public void populateTransactionTable() {
        ...
        for (int iTransaction = 0; iTransaction < nTransaction; ++(iTransaction)) {
            ...
            // Construct a date string. String.split. Integer.parseInt
            if (day < 10) {
    ...
    // The function populates user-bank-accounts table.
    // Since we have three users and each has 1 checking and 1 saving account,
    // we can assign the accounts in order.
    ...
    public void populatePurchaseTable() {
        ...
        // Initialize an arraylist to contain transaction id in an random order.
        ...
        // for each user, get n transactions or transaction IDs, after
        // shuffling.
        for (int iUser = 0; iUser < NUMBER_USER; ++(iUser)) {

            // for each of n transaction ids
