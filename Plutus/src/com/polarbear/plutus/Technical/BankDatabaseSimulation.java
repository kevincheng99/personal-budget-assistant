...
public class BankDatabaseSimulation {
  ...
  private static final String[] SHOPPING_CATEGORY = new String[] { "food", "groceries", "bills",
      "clothing", "housing", "gas", "transportation", "entertainment", "others" };
  ...
  private static final int NUMBER_TRANSACTION_PER_USER = 30;
